      ...
      <div className="flex items-center justify-center p-6 md:p-10">
        ...
        >
          ...
          <div className="flex rounded-lg border border-gray-200 mb-6 overflow-hidden">
            <button
              className={`flex-1 py-3 px-4 transition-all ${activeTab === "login" 
            ...
            <button
              className={`flex-1 py-3 px-4 transition-all ${activeTab === "signup" 
                ? "bg-white text-indigo-600 font-medium shadow-sm" 
                : "bg-gray-100 text-gray-500 hover:text-gray-700 hover:bg-gray-50"}`}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    id="fullName"
                    type="text"
                    className="form-input pl-10 text-gray-800"
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-xs text-indigo-300" title="Password requirements">
                  Min. 7 characters
                </span>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  className="form-input pl-10 text-gray-800 pr-10"
                  placeholder="••••••••"
                  value={password}
            ...
            {activeTab === "signup" && (
              <>
                ...
                <div>
                  ...
                  <div className="relative">
                  <div className="absolute left-3 top-1/2 -translate-y-1/2 text-indigo-300 z-10">
                  ...
                  <DatePicker
                    ...
                    showYearDropdown
                    dropdownMode="select"
                    className="form-input pl-10 text-gray-800 w-full"
            ...
            <p className="text-center text-sm text-muted-foreground mt-6">
              {activeTab === "login" ? (
                <>
                  ...
                  <Link href="/auth?tab=signup" className="text-indigo-400 hover:underline">
                    Sign up
                  </Link>
                </>
              ) : (
                <>
                  ...
                  <Link href="/auth?tab=login" className="text-indigo-400 hover:underline">
                    Sign in
                  </Link>
                </>
              )}
