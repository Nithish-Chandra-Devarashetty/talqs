...
import { Send, Play, Pause, AlertCircle, MessageSquare, Sparkles, Bot, User, Download, Clock, History, FileText, File, Trash2 } from "lucide-react"
                    ...
                    <div className="p-4 border-b flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button 
                          ...
                          onClick={() => {
                            if (confirm('Are you sure you want to delete your entire conversation history? This action cannot be undone.')) {
                              // Call the API to delete history
                              const userId = persistentUserId || getUserId();
                              ...
                              .then(response => {
                                if (response.ok) {
                                  // Clear local state
                                  setPreviousChats([]);
                                  alert('Conversation history has been deleted');
                                } else {
